...
public class ConsumableRecipes {
	...
	public static void register() {
		...
		//Food
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.animan, 1), new Object[] { "MSM", "SFS", "MSM", 'M', ModItems.spongebob_macaroni, 'S', ModItems.powder_schrabidium, 'F', ModItems.grenade_fuze});
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.spongebob_macaroni, 1), new Object[] { "SWS", "WFW", "SWS", 'S', Blocks.sponge, 'W', GOLD.wireFine(), 'F', ModItems.canned_conserve});

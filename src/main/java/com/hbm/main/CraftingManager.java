...
public class CraftingManager {
	...
	public static void reg2() {
		...
		addShapelessAuto(new ItemStack(ModItems.padlock_ror, 1), new Object[] {ModItems.padlock_reinforced, ModBlocks.radio_torch_receiver});
		...
		addRecipeAuto(new ItemStack(ModBlocks.cargo_elevator_stop, 1), new Object[] { "GGG", "SPS", 'G', ModBlocks.steel_grate, 'S', STEEL.ingot(), 'P', new ItemStack(ModItems.part_generic, 1, EnumPartType.PISTON_HYDRAULIC.ordinal()) });
		addRecipeAuto(new ItemStack(ModBlocks.cargo_elevator_extension, 3), new Object[] { "B B", "S S", "B B", 'B', ModBlocks.steel_beam, 'S', STEEL.ingot() });
